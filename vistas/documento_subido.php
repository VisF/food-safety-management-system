    ...
    public static function mostrar(): void
    {
        ...
        <main class="app-container">
            <div class="app-vista-card app-vista-card--surface">
                ...
                <div class="mt-4">
                    <a href="<?= BASE_URL ?>/manipulacionDeAlimentos/subida_documentacion" class="app-vista-button app-vista-button--secondary">Subir otro archivo</a>
                    <a href="<?= BASE_URL ?>/manipulacionDeAlimentos/index" class="app-vista-button app-vista-button--primary">Ir al inicio</a>
                </div>
            </div>
        </main>
        <?php
